...
$sqlstr = "update yx_books set name = '".$_POST[name]."', price = '".$_POST[price]."',images = '".$images."',detail = '".$_POST[detail]."',uploadtime = '".$_POST[uptime]."', type = '".$_POST[type]."',total = '".$_POST[total]."', writer = '".$_POST[writer]."' , publisher = '".$_POST[publisher]."', ISBN = '".$_POST[ISBN]."'where id = ".$_GET[id];
      ...
      <table width="100%" height="173" border="0" align="center" cellpadding="2" cellspacing="1" class="table">
		...
		<tr>
          ...
          <td class="td_bg"><label>
            <input name="writer" type="text" id="writer" value="<?php echo $rows[9]; ?>" size="32" maxlength="255" />
          </label></td>
        </tr>
		<tr>
          <td align="right" class="td_bg">出版者：</td>
          <td class="td_bg"><label>
            <input name="publisher" type="text" id="publisher" value="<?php echo $rows[10]; ?>" size="32" maxlength="255" />
          </label></td>
        </tr>
		<tr>
          <td align="right" class="td_bg">ISBN：</td>
          <td class="td_bg"><label>
            <input name="ISBN" type="text" id="ISBN" value="<?php echo $rows[11]; ?>" size="32" maxlength="255" />
          </label></td>
        </tr>
        <tr>
